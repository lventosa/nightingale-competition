...
#Drama: amb la data no estacionària no es pot aplicar el model autoregressiu però un cop la diferencio i es converteicx en estacionària (total_deaths_diff) o quasi-estacionària (total_death_diff2) no hi ha cap lag (potencials regressors aquí) que semblin ser significatius. Per tant, a la regressió tampoc ho seran --> No afegim aquests dos models? Jo deixaria el raonament aquest explicant why not
