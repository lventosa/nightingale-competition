...
A tenir en compte per quan fem les interpretacions dels models
...
acf(data$total_deaths) #Exponential decay
pacf(data$total_deaths) #Només hi ha un lag que sigui significatiu 
...
reg7 <- lm(data$total_deaths ~ data$time_period, data=data)
summary(reg7) #No significació del time period sobre total deaths
coeftest(reg7, NeweyWest(reg7))
```
